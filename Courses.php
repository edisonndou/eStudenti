...
<body class="bg-light fw-bold">
  ...
  <div class="container-fluid mt-3">
    <div class="row">
      ...
      <div class="row">
        <?php $stm= $pdo->query('SELECT * FROM add_courses'); while($row=$stm->fetch()){?>
        <div class="col-sm-12 col-md-4 col-lg-3">
          <div class="card">
            <img src="https://monpetitdev.fr/wp-content/uploads/2019/05/learn-C-sharp-programming.jpg"
              class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title"><?php echo $row['course_name']; ?></h5>
              <div class="d-block mb-3">
                <?php echo $row['course_for']; ?>
              </div>
              <div class="d-block mb-3">
                <?php echo $row['price'] .'€'; ?>
              </div>
              <div class="d-grid gap-2">
                <a href="ViewCourse.php?id=<?php echo $row['id']; ?>"
                  class="btn btn-primary text-uppercase fw-bold">Shiko Më Shumë</a>
